<template>
    ...
    <div class="row m-l-none m-r-none">
        <div class="panel no_box_shadow m-b-sm">
            <div :class="['panel-heading','no_border_radius','common_panel_heading_div',abc.displayHomePagePanel === 'speaker' ?'opened_panel_bg':'collapse_panel_bg']">
                <span >Speaker </span>
                <span v-on:click='setDHP("speaker")' class="pull-right cursor_pointer">
                    {{abc.displayHomePagePanel==='speaker' ? '&#x2212;' : '&#x2b;'}}
                </span>
            </div>
            <div class="panel-body home_page_panel_body padding_10 b b-t-none" v-if="abc.displayHomePagePanel === 'speaker'">
