<template>
    ...
    <div class="row m-l-none m-r-none">
        <div class="panel no_box_shadow m-b-sm">
            <div :class="['panel-heading','no_border_radius','common_panel_heading_div',abc.displayHomePagePanel === 'video-gallery' ?'opened_panel_bg':'collapse_panel_bg']">
                <span >Video Gallery </span>
                <span v-on:click='setDHP("video-gallery")' class="pull-right cursor_pointer">
                    {{abc.displayHomePagePanel==='video-gallery' ? '&#x2212;' : '&#x2b;'}}
                </span>
            </div>
            <div class="panel-body home_page_panel_body b b-t-none padding_10" v-if="abc.displayHomePagePanel === 'video-gallery'">
