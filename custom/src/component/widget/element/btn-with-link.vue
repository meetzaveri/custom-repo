<template>
    <!--Button with Link-->
    <div class="panel no_box_shadow m-b-none b-t-none b-l-none">
            ...
            <div class="row div_wrapper m-l-none m-r-none m-t-sm m-b">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="row m-t">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <label >Link</label>
                            <input type="text" @input="send_data" v-model="c_data[index].option" class="form-control font_size_11" placeholder="Enter URL">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
...
<script>
    export default{
        ...
        methods:{
            ...
            send_data:function(){
                this.$socket.emit('btn_with_link_ele',{data:this.c_data,name:this.c_name,index:this.c_index},"client1:slave");
            },
