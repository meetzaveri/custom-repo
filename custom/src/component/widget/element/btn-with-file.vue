                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="row m-t">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="choose_file_div pull-left">
                                        <span>Choose File</span>
                                    </div>
                                    <div class="pull-left m-l-sm m-t-xs">
                                        <span class="ticket_info_subline_text_color font_size_11">No File Choosen</span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    export default{
        ...
        methods:{
            ...
            send_data:function(){
                this.$socket.emit('btn_with_file_ele',{data:this.c_data,name:this.c_name,index:this.c_index},"client1:slave");
            },
